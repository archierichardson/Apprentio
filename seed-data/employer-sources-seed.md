# Apprenticeship Target List — London-Centric & <2hr Commute

**Constraint:** London-based or max 1 hour commute (Archie cannot relocate; salary higher in London).

**Status:** Level 6 Cybersecurity Degree Apprenticeships ONLY. Verified: Deloitte (L4 BrightStart—removed), Amazon/Lloyds/Vodafone (L4—removed). Wave 1 reduced to 2 confirmed L6 programmes.
...
- ~~HSBC~~ (marked removed, current offerings are L4)
- ~~Capgemini DTS DA~~ (marked removed; status uncertain between L4/L6)
- ~~Accenture~~ (marked removed; cyber L6 status unclear)
...
- ~~Vodafone~~ **REMOVED: Current postings are L4 Higher Apprenticeships, NOT L6 Degree.** Newbury location ✓ but programme level incorrect. Verify 2027 cycle if pursuing.
- ~~Lloyds Banking Group~~ **REMOVED: Current offerings are L4 Higher Apprenticeships only, NOT L6 Degree.** Do not pursue unless L6 confirmed.

---

## NOT PURSUING (>2 hours or ruled out by constraints)

| Employer | Reason |
|---|---|
| Bank of America | Chester (>2 hours from London) |
| Thales | Glasgow (>2 hours; cannot relocate) |
| Rolls-Royce | Derby (>2 hours) |
| National Grid | Warwick (>2 hours) |
| Raytheon UK | Corsham, Wiltshire (~2 hours, borderline; check commute reality) |
| AstraZeneca | Cambridge (~1.5 hours; borderline — verify if acceptable to Archie) |
| Leonardo, QinetiQ, Leidos, MBDA, Serco | Location verification pending; assume defence contracts = dispersed UK sites (not London-centric) |

---

## Total target count (London-centric, L6 VERIFIED)

- **Wave 1:** 2 applications (Government/Defence, highest priority, earliest closes)
- **Wave 2:** 8 applications (Consulting + Tech, rolling Jan 2027)
- **Wave 3:** 6 applications (Financial Services, spring window)
- **Total:** 16 confirmed/likely L6 employers (down from 24)

**Removed:** 8 employers
- Wave 1: Goldman Sachs, HSBC, Capgemini, Accenture (marked removed in prior research)
- Wave 2: Deloitte (L4 BrightStart Cyber only)
- Wave 3: Amazon, Vodafone, Lloyds (all L4 Higher, not L6 Degree)

**Pending verification:**
- NCC Group (L6 status + UK location unclear — specialist firm)
- Marsh McLennan (L6 status — likely but direct verification blocked)

This concentrated list is guaranteed L6-focused and location-viable (London + ≤1 hour commute).

---

## Immediate next steps (after Archie approves this revised list)

1. **Approve revised list** — confirm 16-17 employers are the target focus.
2. **Verify NCC Group + Marsh McLennan** — confirm L6 status and (for NCC) UK/London location feasibility.
3. **Finalise Personal Statement v3** — add outstanding gaps (Lenovo, Vaultwarden, TV hacking, PD criteria).
4. **Build master CV + Cover Letter templates** — aligned to ST0409 competencies (cyber risk, secure solutions, incident response, team leadership).
5. **Bookmark career pages** — all 16+ employers' career pages, set email alerts for job posting updates.

Once approved, Careers agent will begin Wave 1 tailoring in August 2026.

---

Created: 2026-06-22 | L6 Verification: 2026-06-22 | Status: Awaiting Archie approval on revised list
